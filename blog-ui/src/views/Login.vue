<template>
  <div class="shell">
    <!-- 注册表单容器（A容器）：自上而下 - username、password、nickname -->
    <div
      class="container a-container"
      :class="{ 'is-txl': isLoginMode }"
      ref="aContainer"
    >
    ...
    <!-- 登录表单容器（B容器）：自上而下 - username、password -->
    <div
      class="container b-container"
      :class="{ 'is-txl is-z': isLoginMode }"
      ref="bContainer"
    >
    ...
    >
      ...
      >
        ...
        <button class="switch_button button switch-btn" @click="toggleMode">
          SIGN IN
        </button>
      </div>
